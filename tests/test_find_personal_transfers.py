...
def test_find_personal_transfers_success():
    transactions = [
        {"Категория": "Переводы", "Описание": "Иванов И.И.", "Сумма": 1000},
        {"Категория": "Переводы", "Описание": "Петров П.П.", "Сумма": 2000},
        {"Категория": "Другое", "Описание": "Магазин", "Сумма": 500},
    ]
...
def test_find_personal_transfers_no_matches():
    transactions = [
        {"Категория": "Другое", "Описание": "Магазин", "Сумма": 500},
        {"Категория": "Перевод", "Описание": "Неверный формат", "Сумма": 1000},
    ]
