...
def test_main_json_save_error(mock_env_vars, mock_1_load_data_from_excel,
                              mock_analyze_transactions, mock_get_currency_rates, mock_get_stock_price):
...
def test_main_stock_api_error(mock_stock_price, mock_currency_rates,
                              mock_env_vars, mock_1_load_data_from_excel, mock_analyze_transactions):
